...
function Policy() {
  return (
    <div class="lg:w-[700px] lg:border border-emerald-600 mb-10 mt-8 m-auto">
      <div class="container mx-auto p-5">
        <h1 class="text-3xl text-center text-emerald-500 font-bold mb-4">
          Privacy Policy
        </h1>
        <p class="mb-4">
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Introductiont</h2>

        <p class="mb-4">
          Darwesh Group ("we", "our", "us") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you visit our website
          www.darweshgroup.com and use our services. Please read this policy
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Information We Collect</h2>
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">How We Use Your Information</h2>
        ...
        <ul class="list-disc list-inside mb-4">
          <li>
            ...
            deliver the services you request and to improve our offerings.
          </li>
          <li>
            To Communicate With You: We may use your contact details to send you
            updates, newsletters, and other information related to your account
            or our services.
          </li>
          <li>
            To Enhance User Experience: We analyze how users interact with our
            site to improve the user experience and the functionality of our
            services.
          </li>
          <li>
            To Comply With Legal Obligations: We may process your data to comply
            with legal obligations or in response to lawful requests by public
            authorities.
          </li>
        </ul>

        <h2 class="lg:text-2xl text-xl font-bold mb-2">Sharing Your Information</h2>
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Data Security</h2>
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Your Data Protection Rights</h2>
        ...
        <ul class="list-disc list-inside mb-4">
          ...
          <li>
            ...
            conditions. us as soon as possible at the above address. We will
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Changes to This Privacy Policy</h2>
        ...
        <h2 class="lg:text-2xl text-xl font-bold mb-2">Contact Us</h2>
        <p class="mb-4">
        ...
        <h2>
          {" "}
          <span className="font-bold">Email:</span> privacy@darweshgroup.com
        </h2>
        <h2>
          {" "}
          <span className="font-bold">Phone:</span> +91 7835082074
        </h2>
      </div>
    </div>
  );
